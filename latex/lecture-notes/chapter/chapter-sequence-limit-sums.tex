...
\begin{example}{Anwendung der Regel von L'Hôpital}{HopitalRule}
    \begin{itemize}
        ...
        \item $\lim\limits_{x\to 0^{+}} x \cdot \ln(x) = \lim\limits_{x\to  0^{+}} \frac{\ln(x)}{1/x} = \lim\limits_{x\to 0^{+}} \frac{1/x}{-1/x^2} = 0$
        \item $\lim\limits_{x\to 0} \frac{\sin(x)}{x} = \lim\limits_{x\to  0} \frac{\cos(x)}{1} = \cos(0) = 1$
    \end{itemize}
\end{example}
